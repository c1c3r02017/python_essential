...
class LinkedList(object):
    ...
    def append(self, value):
        ...
        """
        new_nodo = LinkedListNode(value)
        current_list = self._head
        if(self._head):
            while current_list.hasNext():
                current_list = current_list.next
            current_list.next = new_nodo
        else:
            self._head = new_nodo
        self._tail = new_nodo
        self._len += 1
    ...
    def insert(self, value):
        ...
        """
        neo_nodo = LinkedListNode(value)
        neo_nodo.next = self._head
        self._head = neo_nodo
        self._len += 1
    ...
    def getValueAt(self, index):
        ...
        """
        try:
            linked_list = self._head
            count = 0
            while count != index:
                count+=1
                linked_list = linked_list.next
        except Exception as err:
            return OutOfBoundsException(err)
